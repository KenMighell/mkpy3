...
# NASA Ames Research Center / SETI Institute
    ...
    if (percentile is None): percentile = 99
    if (cmap is None): cmap = 'gray_r'
    ...
    #
    # set plot parameters    ax.tick_params(axis='y', labelsize=16 ) 
    ...
    if (title != ''): ax.set_title(title,size=20)
    ax.set_aspect(1)
    #
    return
pass#def
...
if (__name__ == '__main__'):
    ...
    percentile = 99.0
    mkpy3_finder_chart_image_show_v1(ax=ax, image_data=survey_data, \
