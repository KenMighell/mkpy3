...
# file://xmkpy3_k2_tpf_overlay_v2.py
...
def xmkpy3_k2_tpf_overlay_v2():
    ...
    kwargs_ = (
        "{'edgecolor':'cyan', 's':300, 'facecolor':'None', 'lw':3, " "'zorder':20}"
    )
    parser.add_argument(
        "--gaia_dr2_kwargs_str",
        action="store",
    ...
    if tpf_filename is not None:
        ...
        tpf = lk.search_targetpixelfile(
            target="k2-34b", mission="k2", campaign=18, cadence="long"  
    ...
    try:
        ...
        print(
            "^--- *** ERROR *** This file does not appear to be a K2 " "TargetPixelFile"
        )
        print()
        print("Bye...\n", flush=True)
        sys.exit(1)
