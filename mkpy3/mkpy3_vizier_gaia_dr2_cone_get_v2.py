...
def xmkpy3_vizier_gaia_dr2_cone_get_v2():
    ...
    dec_deg = +42.7843585094725  # RR Lyr
    radius_arcsec = 20
    raj2000, dej2000, sep_arcsec, gaia_dr2_result = mkpy3_vizier_gaia_dr2_cone_get_v2(
        ra_deg=ra_deg, dec_deg=dec_deg, radius_arcsec=radius_arcsec, verbose=True
    )

    assert gaia_dr2_result is not None
    name = np.array(gaia_dr2_result["DR2Name"], dtype=str)
    print("\n#GAIA2_DR2:")
    ...
    print()
    print(
        "# n GAIA2_Source             sep  RA_ICRS       DE_ICRS        pmRA"
        "     pmDE      Plx"
    )
    print(
        "#                       [arcsec]  [deg]         [deg]      [mas/yr]"
        " [mas/yr]    [mas]"
    )
    for k in range(len(xra)):
        ...
        plxj = plx[j]
        print(
            "%3d %d %8.3f %12.7f %12.7f %8.3f %8.3f %8.3f"
    ...
    print()
    print(
        "# n GAIA2_Source          Gmag    RA_ICRS       DE_ICRS      RA_ICR"
        "S         DE_ICRS"
    )
    print(
        "#                         [mag]   [deg]         [deg]        [hms] "
